...
# We can see that accuracy of training set is higher than the cross validation accuracy,
# because the model did not see the validation data during training